...
class OnlineViewController: UIViewController, WKUIDelegate, WKNavigationDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        title = webView.title ?? webView.url?.absoluteString ?? "Oracc Web"
    }
    ...
    func webView(_ webView: WKWebView, didFailProvisionalNavigation navigation: WKNavigation!, withError error: Error) {
        let alert = UIAlertController(title: "Unable to load page", message: "Unable to reach server", preferredStyle: .alert)
